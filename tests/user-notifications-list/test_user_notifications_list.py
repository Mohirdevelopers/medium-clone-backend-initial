...
@pytest.fixture
def notification_data(user_factory, notification_factory):
    """
    Create notification data for testing.
    """
    user = user_factory.create()
    notifications = notification_factory.create_batch(3, user=user, read_at=None)
...
@pytest.fixture
def single_notification(user_factory, notification_factory):
    """
    Create a single notification for testing.
    """
    user = user_factory.create()
    notification = notification_factory.create(user=user, read_at=None)
