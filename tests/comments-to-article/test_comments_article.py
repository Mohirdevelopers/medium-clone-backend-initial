...
@pytest.fixture
def create_comments_data(request, user_factory, article_factory):
    """
    ...
    article_inactive = article_factory.create(author=user, status=ArticleStatus.PENDING)
...
@pytest.fixture
def delete_comment_data(request, user_factory, article_factory, comment_factory):
    """
    ...
    article = article_factory.create(author=user)
    comment = comment_factory.create(article=article, user=user)
...
@pytest.fixture
def update_comment_data(request, user_factory, article_factory, comment_factory):
    """
...
@pytest.fixture
def create_comment_with_parent_data(request, user_factory, article_factory, comment_factory):
    """
    Provides test data for creating a comment with a parent.
    """
    user = user_factory.create()
    article = article_factory.create(author=user)
    parent_comment = comment_factory.create(article=article, user=user)
...
@pytest.fixture
def get_comment_from_article(request, user_factory, article_factory, comment_factory):
    """
    ...
    comments = [
        comment_factory.create(article=article, user=user, content="Comment 1"),
        comment_factory.create(article=article, user=user, content="Comment 2"),
        comment_factory.create(article=article, user=user, content="Comment 3")
    ]
